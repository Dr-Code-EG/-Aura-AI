...
import com.drcode.clock.chatgpt.PendingScreenshotHolder
...
class ScreenCaptureService : Service() {
    ...
    private fun startForegroundCompat() {
        ...
        val notif: Notification = NotificationCompat.Builder(this, ClockApp.CHANNEL_CAPTURE)
    ...
    private fun captureOnce(projection: MediaProjection) {
        ...
        val thread = HandlerThread("ClockCapture").apply { start() }
