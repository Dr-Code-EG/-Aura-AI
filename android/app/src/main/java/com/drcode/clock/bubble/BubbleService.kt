...
import com.drcode.clock.ClockApp
import com.drcode.clock.R
import com.drcode.clock.capture.CaptureRequestActivity
import com.drcode.clock.ui.MainActivity
 ...
 * [com.drcode.clock.capture.ScreenCaptureService] and finally into
 * [com.drcode.clock.chatgpt.ChatGptActivity].
 *
...
class BubbleService : Service() {
    ...
    private fun showBubble() {
        ...
        val clock = ClockFaceView(this).apply {
            contentDescription = getString(R.string.app_name)
        }
        val sizePx = TypedValue.applyDimension(
            TypedValue.COMPLEX_UNIT_DIP, 64f, resources.displayMetrics,
        ).toInt()
        container.addView(clock, FrameLayout.LayoutParams(sizePx, sizePx))
    ...
    companion object {
        const val ACTION_STOP = "com.drcode.clock.STOP_BUBBLE"
